...
from proxy_lite.browser.bounding_boxes import BoundingBox
...
class BaseEnvironment(BaseModel, ABC):
    ...
    @abstractmethod
    async def get_bounding_boxes(self) -> list[BoundingBox]:
        """
        Returns a list of bounding boxes for the current state of the environment.
        This is primarily used for visualization and debugging purposes.
        """
        ...
